    ...
    return {
        ...
        "profiles": {
            "fidel": {
                ...
                "weight_logs": [
                    {"date": three_weeks_ago, "weight": 85.5, "notes": "Inicio del seguimiento"},
                    {"date": two_weeks_ago, "weight": 84.7, "notes": "Mejora en energía y descanso"},
                    {"date": one_week_ago, "weight": 83.9, "notes": "Semana de alta adherencia al gym"},
                    {"date": today_str, "weight": 83.2, "notes": "Progreso sostenido -2.8kg acumulados"},
                ],
                "habits_history": {
                    "gym": [
                ...
                "active_program": {
                    "id": "prog-fidel-12w",
                    "title": "Programa 12 Semanas: Transformación & Pérdida de Grasa (-8kg)",
                    "target_loss_kg": 8.0,
                    "duration_weeks": 12,
                    ...
                    "nutrition_plan": {
                        ...
                        "carbs_g": 195,
                        "fats_g": 65,
                        "strategy": "Déficit calórico moderado de ~400 kcal respecto al mantenimiento estimado (2550 kcal). Alta ingesta de proteína (2.0g por kg de masa magra) para preservar tejido muscular y maximizar efecto térmico.",
                        "meal_guidelines": [
                            "Desayuno: Proteína de alto valor biológico (huevos/claras) con carbohidratos complejos (avena) y frutos rojos.",
                            "Comida / Pre-entreno: Pechuga de pollo/res magra con arroz jazmín o camote y verduras al vapor 90-120 min antes del gym.",
                            "Post-entreno / Cena: Pescado/atún o batido whey con ensalada verde variada y aceite de oliva virgen.",
                            "Hidratación: Mínimo 3.0 litros de agua distribuidos durante el día (500ml al despertar y 1L durante el entrenamiento).",
                        ],
                    },
                    "workout_split": {
